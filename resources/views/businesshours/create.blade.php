...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
      ...
      <li class="breadcrumb-item text-sm text-white active"><a class="opacity-5 text-white" href="javascript:;">Set Business Hours</a></li>
    </ol>
    <h6 class="font-weight-bolder mb-0 text-white">Set Business Hours</h6>
  </nav>
@endsection
...
<div class="row">
  <div class="col-12 mx-auto">
    <form action="{{ route('businesshours.store') }}" method="POST">
      @csrf
      <div class="row">
        <div class="col-12">
          <div class="card">
            <div class="card-body">
              <div class="row">
                ...
                <div class="form-group col-md-4">
                    ...
                    <input type="text" class="form-control" name="name" id="businessName" placeholder="e.g. Chicago Business Hours" required>
                </div>
                ...
                <div class="form-group col-md-6">
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="businesshourstype" id="24x7" value="24x7">
                        <label class="form-check-label" for="24x7">
                            24 hrs x 7 days <small class="text-muted">Round the clock support</small>
                        </label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="businesshourstype" id="customBusinessHours" value="custom" checked>
                ...
                <div class="day-selector form-group col-md-6" id="day-selector">
                ...
                <div id="working-hours-day">
                  <div class="row g-3 align-items-center mb-3">
                      <div class="col-md-3">
                          <label class="form-label">Monday</label>
                      </div>
                      <div class="col-md-3">
                          <input type="time" name="monday_start" class="form-control" value="08:00">
                      </div>
                      <div class="col-md-1 text-center">
                          to
                      </div>
                      <div class="col-md-3">
                          <input type="time" name="monday_end" class="form-control" value="17:00">
                      </div>
                      <div class="col-md-2">
                  ...
                  <div class="row g-3 align-items-center mb-3">
                      ...
                      <div class="col-md-3">
                          <input type="time" name="tuesday_start" class="form-control day_start_time" value="08:00">
                      </div>
                      <div class="col-md-1 text-center">
                          to
                      </div>
                      <div class="col-md-3">
                          <input type="time" name="tuesday_end" class="form-control day_end_time" value="17:00">
                      </div>
                  </div>
                  ...
                  <div class="row g-3 align-items-center mb-3">
                      ...
                      <div class="col-md-3">
                          <input type="time" name="wednesday_start" class="form-control day_start_time" value="08:00">
                      </div>
                      <div class="col-md-1 text-center">
                          to
                      </div>
                      <div class="col-md-3">
                          <input type="time" name="wednesday_end" class="form-control day_end_time" value="17:00">
                      </div>
                  </div>
                  ...
                  <div class="row g-3 align-items-center mb-3">
                      ...
                      <div class="col-md-3">
                          <input type="time" name="thursday_start" class="form-control day_start_time" value="08:00">
                      </div>
                      <div class="col-md-1 text-center">
                          to
                      </div>
                      <div class="col-md-3">
                          <input type="time" name="thursday_end" class="form-control day_end_time" value="17:00">
                      </div>
                  </div>
                  ...
                  <div class="row g-3 align-items-center mb-3">
                      ...
                      <div class="col-md-3">
                          <input type="time" name="friday_start" class="form-control day_start_time" value="08:00">
                      </div>
                      <div class="col-md-1 text-center">
                          to
                      </div>
                      <div class="col-md-3">
                          <input type="time" name="friday_end" class="form-control day_end_time" value="17:00">
                      </div>
                  </div>
                  ...
                  <div class="row g-3 align-items-center mb-3">
                      ...
                      <div class="col-md-3">
                          <input type="time" name="saturday_start" class="form-control day_start_time" value="08:00">
                      </div>
                      <div class="col-md-1 text-center">
                          to
                      </div>
                      <div class="col-md-3">
                          <input type="time" name="saturday_end" class="form-control day_end_time" value="17:00">
                      </div>
                  </div>
                  ...
                  <div class="row g-3 align-items-center mb-3">
                      ...
                      <div class="col-md-3">
                          <input type="time" name="sunday_start" class="form-control day_start_time" value="08:00">
                      </div>
                      <div class="col-md-1 text-center">
                          to
                      </div>
                      <div class="col-md-3">
                          <input type="time" name="sunday_end" class="form-control day_end_time" value="17:00">
                      </div>
                  </div>
                </div>
              </div>
