            ...
            <div class="card-body">
              <div class="row">
                  ...
                  <div class="form-group col-md-3 @error('name') is-invalid @enderror">
                    ...
                    <input type="text" name="name" class="form-control" id="name" value="{{$employee->name}}" placeholder="Name">
                    @error('name')
                  ...
                  <div class="form-group col-md-3 @error('mobile') is-invalid @enderror">
                    ...
                    <input type="number" name="mobile" class="form-control" id="mobile" value="{{$employee->mobile}}" placeholder="Mobile Number">
                    @error('mobile')
                        <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                  </div>
                  ...
                  <div class="form-group col-md-2 @error('grade') is-invalid @enderror">
                    ...
                    <input type="text" name="grade" class="form-control" id="grade" value="{{$employee->grade}}" placeholder="Grade">
                    @error('grade')
                        <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                  </div>
                  ...
                  <div class="form-group col-md-2 @error('user_id') is-invalid @enderror">
                    ...
                    <input type="text" name="user_id" value="{{$employee->user_id}}" class="form-control" id="user_id" placeholder="User ID">
                    @error('user_id')
                        <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                  </div>
                  ...
                  <select class="form-control" name="roles" id="roles" >
                      @foreach($roles as $role)
                        <option {{$employee->user->roles->pluck('name')->first() == $role->name ? "selected" : ""}} value="{{$role->name}}">{{$role->name}}</option>
                      @endforeach
                    </select>
                  </div>
                  ...
                  <select class="form-control" name="sub_region_id" id="sub_region_id" >
                      @foreach($sub_regions as $sub_region)
                        <option {{$employee->sub_region_id == $sub_region->id ? "selected" : ""}} value="{{$sub_region->id}}">{{$sub_region->name}}</option>
                      @endforeach
                    </select>
                  </div>
                  ...
                  <div class="form-group col-md-2 @error('report_to') is-invalid @enderror">
                    ...
                    <input type="text" name="report_to" value="{{$employee->report_to}}" class="form-control" id="report_to" placeholder="Report To">
                    @error('report_to')
                        <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                  </div>
                  ...
                  <div class="form-group col-md-3 @error('email') is-invalid @enderror">
                    ...
                    <input type="text" name="email" value="{{$employee->email}}" class="form-control" id="email" placeholder="Email Address">
                    @error('email')
                        <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                  </div>
                  ...
                  <div class="form-group col-md-3 @error('secondary_email') is-invalid @enderror">
                    ...
                    <input type="text" name="secondary_email" value="{{$employee->secondary_email}}" class="form-control" id="secondary_email" placeholder="Secondary Email Address">
