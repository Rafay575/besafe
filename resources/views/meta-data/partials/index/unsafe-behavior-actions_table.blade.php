@php
$collection = $unsafe_behavior_actions;
$title_field = "action_title";
$desc_field = "action_desc";
$meta_data_name = "unsafe_behavior_actions";
$heads = "S.No,Action ID,Action Title,Group,Date Created,Actions";
@endphp
