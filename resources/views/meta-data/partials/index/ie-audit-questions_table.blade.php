@php
    $collection = $internalExternalAuditQuestions;
    $title_field = "question";
    $desc_field = "question_desc";
    $meta_data_name = "ie_audit_questions";
    $heads = "S.No,question ID,question,Audit Type,Group,Date Created,Actions";
@endphp
