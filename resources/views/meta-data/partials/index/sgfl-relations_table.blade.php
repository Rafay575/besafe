@php
$collection = $sgflRelations;
$title_field = "sgfl_relation_title";
$desc_field = "sgfl_relation_desc";
$meta_data_name = "sgfl_relations";
$heads = "S.No,sgfl relation ID,sgfl relation title,Group,Date Created,Actions";
@endphp
