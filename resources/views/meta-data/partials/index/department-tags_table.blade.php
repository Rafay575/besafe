@php
$collection = $departmentTags;
$title_field = "department_tag_title";
$desc_field = "department_tag_desc";
$meta_data_name = "department_tags";
$heads = "S.No,department tag ID,department tag title,Group,Date Created,Actions";
@endphp
