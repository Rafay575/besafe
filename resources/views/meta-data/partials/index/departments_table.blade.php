@php
    ...
    $title_field = "department_title";
    $desc_field = "department_desc";
    $meta_data_name = "departments";
    $heads = "S.No,Departmenent ID,Department Title,Group,Date Created,Actions";
@endphp
