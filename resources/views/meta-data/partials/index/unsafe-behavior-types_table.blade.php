@php
$collection = $unsafeBehaviorTypes;
$title_field = "unsafe_behavior_type_title";
$desc_field = "unsafe_behavior_type_desc";
$meta_data_name = "unsafe_behavior_types";
$heads = "S.No,unsaef behavior type ID,unsaef behavior type title,Group,Date Created,Actions";
@endphp
