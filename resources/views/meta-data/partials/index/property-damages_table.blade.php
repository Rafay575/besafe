@php
$collection = $propertyDamages;
$title_field = "property_damage_title";
$desc_field = "property_damage_desc";
$meta_data_name = "property_damages";
$heads = "S.No, propery damage ID, propery damage title,Group,Date Created,Actions";
@endphp
