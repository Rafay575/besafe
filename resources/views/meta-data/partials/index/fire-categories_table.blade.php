@php
$collection = $fireCategories;
$title_field = "fire_category_title";
$desc_field = "fire_category_desc";
$meta_data_name = "fire_categories";
$heads = "S.No,fire category ID,fire category title,Group,Date Created,Actions";
@endphp
