@php
    ...
    $title_field = "designation_title";
    $desc_field = "designation_desc";
    $meta_data_name = "designations";
    $heads = "S.No,Designation ID,Designation Title,Group,Date Created,Actions";
@endphp
