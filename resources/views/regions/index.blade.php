...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
      ...
      <li class="breadcrumb-item text-sm text-white active"><a class="opacity-5 text-white" href="javascript:;">Region List</a></li>
    </ol>
    <h6 class="font-weight-bolder mb-0 text-white">Region List</h6>
  </nav>
@endsection
              ...
              <div class="ms-auto my-auto mt-lg-0 mt-4">
                @can('adminsetting.create')    
                  <div class="ms-auto my-auto">
                    <a href="{{route('regions.create')}}" class="btn bg-gradient-primary btn-sm mb-0" >+&nbsp; Add New</a>
                  </div>
                @endcan
              </div>
            </div>
          ...
          <table class="table table-flush dataTable table-striped no-footer" id="departments-table">
            ...
            @foreach($regions as $region)
              <tr>
                ...
                <td>
                  <div class="d-flex align-items-center">
                    {{$region->parent ? $region->parent->name : "Main Region"}}
                  </div>
                </td>
                <td>
                   <div style="width: 45px;">
                    ...
                    <form action="{{route('regions.destroy', $region->id)}}" method="post" style="float:right;">
