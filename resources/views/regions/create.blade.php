...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
      ...
      <li class="breadcrumb-item text-sm text-white active"><a class="opacity-5 text-white" href="javascript:;">Create Region</a></li>
    </ol>
    <h6 class="font-weight-bolder mb-0 text-white">Create New Region</h6>
  </nav>
@endsection
            ...
            <div class="card-body">
              <div class="row">
                  ...
                  <div class="form-group col-md-3 @error('name') is-invalid @enderror">
                    ...
                    <input type="text" name="name" class="form-control" id="name" placeholder="Region Name">
                    @error('name')
