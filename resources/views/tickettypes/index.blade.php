...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
      ...
      <li class="breadcrumb-item text-sm text-white active"><a class="opacity-5 text-white" href="javascript:;">Ticket Type List</a></li>
    </ol>
    <h6 class="font-weight-bolder mb-0 text-white">Ticket Type List</h6>
  </nav>
@endsection
              ...
              <div class="ms-auto my-auto mt-lg-0 mt-4">
                @can('adminsetting.create')    
                  <div class="ms-auto my-auto">
                    <a href="{{route('tickettypes.create')}}" class="btn bg-gradient-primary btn-sm mb-0" >+&nbsp; Add New</a>
                  </div>
                @endcan
              </div>
            </div>
              ...
              <tr>
                ...
                <td>
                   <div style="width: 13%;">
                    ...
                    <a 
                        href="{{route('tickettypes.edit', $tickettype->id)}}" 
                        class="mx-2" 
                    ...
                    <form action="{{route('tickettypes.destroy', $tickettype->id)}}" method="post" style="float:right;">
