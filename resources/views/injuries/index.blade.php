...
@section('breadcrumb')
<x-templates.breadcrumb page-title="Injuries List">
        ...
        <div class="table-responsive">
            <table class="table table-flush" id="dataTable">
              <thead class="thead-light">
                <x-table.tblhead heads="S.No,Incident Category,Employee Involved,Employee Contractor,Date,Action"></x-table.tblhead>
              </thead>
              <tbody>
              </tbody>
              <tfoot>
