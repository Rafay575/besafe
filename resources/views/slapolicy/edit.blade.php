...
<div class="row">
  <div class="col-12 mx-auto">
      <form action="{{ route('slapolicies.update',$slapolicy->id) }}" method="post" enctype="multipart/form-data">
      @csrf
            ...
            <div class="card-body">
              ...
              <div class="row">
                ...
                <div class="form-group col-md-4">
                    ...
                    <input type="text" class="form-control" name="name" id="name" value="{{$slapolicy->name}}" placeholder="e.g. Chicago Business Hours" required>
                </div>

                <div class="form-group col-md-8">
                    <label for="description" class="form-label">Description</label>
                    <input type="text" class="form-control" name="description" value="{{$slapolicy->description}}" id="description" placeholder="e.g. This Business Calendar belongs to Chicago timezone">
                </div>
                        ...
                        <tbody>
                          @foreach($priorities as $priority)
                            ...
                            <tr>
                                ...
                                <td><input type="text" name="{{strtolower($priority->priority)}}_first_response_time" value="{{ $slapolicy->{strtolower($priority->priority)."_first_response_time"} }}" class="form-control" placeholder="10m"></td>
                                <td><input type="text" name="{{strtolower($priority->priority)}}_resolution_time" value="{{ $slapolicy->{strtolower($priority->priority)."_resolution_time"} }}" class="form-control" placeholder="10m"></td>
                                <td>
                                ...
                                <td>
                                    <div class="form-check form-switch">
                                        ...
                                        <input name="{{strtolower($priority->priority)}}_escalation" class="form-check-input" type="checkbox" {{ $slapolicy->{strtolower($priority->priority)."_escalation"} == "on" ? "checked" : "" }}>
                                    </div>
                                </td>
                            </tr>
                          @endforeach
