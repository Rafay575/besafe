...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
      ...
      <li class="breadcrumb-item text-sm text-white active"><a class="opacity-5 text-white" href="javascript:;">Ticket Sub Type List</a></li>
    </ol>
    <h6 class="font-weight-bolder mb-0 text-white">Ticket Sub Type List</h6>
  </nav>
@endsection
    ...
    <div class="col-12">
      <div class="card bg-white-custom lightborder-unique shadow-lg">
        ...
        <div class="card-header  bg-white-custom pb-0">
            <div class="d-lg-flex">
              <div>
                <h5 class="mb-0">Ticket Sub Type</h5>
                <p class="text-sm mb-0">
                 List of Ticket Sub Type
                </p>
              </div>
              <div class="ms-auto my-auto mt-lg-0 mt-4">
                @can('adminsetting.create')    
                  <div class="ms-auto my-auto">
                    <a href="{{route('ticketsubtypes.create')}}" class="btn bg-gradient-primary btn-sm mb-0" >+&nbsp; Add New</a>
                  </div>
                @endcan
              </div>
            </div>
              ...
              <tr>
                ...
                <td>
                   <div style="width: 10%;">
                    ...
                    <a 
                        href="{{route('ticketsubtypes.edit', $ticketsubtype->id)}}" 
                        class="mx-2" 
                        ...
                        data-container="body" 
                        data-animation="true" 
                        data-bs-original-title="edit Sub Type"
                      >
                      <i class="fas fa-user-edit text-purple"></i>
                    </a>

                    <form action="{{route('ticketsubtypes.destroy', $ticketsubtype->id)}}" method="post" style="float:right;">
