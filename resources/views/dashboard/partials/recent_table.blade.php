        ...
        <table class="table table-striped table-hover ">
            ...
            <tbody>
                ...
                @foreach ($tickets as $ticket)
                    <tr>
                        <td style="padding:10px ; text-align:justify;">{{ $ticket['id'] }}</td>
                        <td style="padding:10px ; text-align:justify;">{{ $ticket['ticket_type'] }}</td>
                        <td style="padding:10px ; text-align:justify;">{{ $ticket['requested_by'] }}</td>
                        <td style="padding:10px ; text-align:justify;">{{ $ticket['assign_to'] }}</td>
                        ...
                        <td style="padding:10px ; text-align:justify;">{{ $ticket['priority'] }}</td>
                    </tr>
                @endforeach
            </tbody>
        </table>
