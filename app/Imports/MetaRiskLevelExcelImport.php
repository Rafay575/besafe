...
class MetaRiskLevelExcelImport implements ToCollection, WithHeadingRow, WithValidation
{

    protected $titleField = "risk_level_title";
    protected $modelClass = MetaRiskLevel::class;
