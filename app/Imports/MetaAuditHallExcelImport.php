...
class MetaAuditHallExcelImport implements ToCollection, WithHeadingRow, WithValidation
{

    protected $titleField = "hall_title";
    protected $modelClass = MetaAuditHall::class;
