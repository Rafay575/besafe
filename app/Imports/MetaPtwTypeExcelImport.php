...
class MetaPtwTypeExcelImport implements ToCollection, WithHeadingRow, WithValidation
{

    protected $titleField = "ptw_type_title";
    protected $modelClass = MetaPtwType::class;
