...
class MetaIncidentCategoryExcelImport implements ToCollection, WithHeadingRow, WithValidation
{

    protected $titleField = "incident_category_title";
    protected $modelClass = MetaIncidentCategory::class;
