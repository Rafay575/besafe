...
class MetaPropertyDamageExcelImport implements ToCollection, WithHeadingRow, WithValidation
{

    protected $titleField = "property_damage_title";
    protected $modelClass = MetaPropertyDamage::class;
