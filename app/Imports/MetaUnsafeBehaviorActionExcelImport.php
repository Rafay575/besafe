...
class MetaUnsafeBehaviorActionExcelImport implements ToCollection, WithHeadingRow, WithValidation
{

    protected $titleField = "action_title";
    protected $modelClass = MetaUnsafeBehaviorAction::class;
