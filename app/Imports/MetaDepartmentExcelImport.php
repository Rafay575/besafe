...
class MetaDepartmentExcelImport implements ToCollection, WithHeadingRow, WithValidation
{

    protected $titleField = "department_title";
    protected $modelClass = MetaDepartment::class;
