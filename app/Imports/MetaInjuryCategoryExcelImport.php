...
class MetaInjuryCategoryExcelImport implements ToCollection, WithHeadingRow, WithValidation
{

    protected $titleField = "injury_category_title";
    protected $modelClass = MetaInjuryCategory::class;
