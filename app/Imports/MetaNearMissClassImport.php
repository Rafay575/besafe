...
class MetaNearMissClassImport implements ToCollection, WithHeadingRow, WithValidation
{

    protected $titleField = "class_title";
    protected $modelClass = MetaNearMissClass::class;
