...
class MetaImmediateCauseExcelImport implements ToCollection, WithHeadingRow, WithValidation
{

    protected $titleField = "cause_title";
    protected $modelClass = MetaImmediateCause::class;
