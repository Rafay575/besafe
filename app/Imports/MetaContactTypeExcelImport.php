...
class MetaContactTypeExcelImport implements ToCollection, WithHeadingRow, WithValidation
{

    protected $titleField = "type_title";
    protected $modelClass = MetaContactType::class;
