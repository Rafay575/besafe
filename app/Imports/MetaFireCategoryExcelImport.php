...
class MetaFireCategoryExcelImport implements ToCollection, WithHeadingRow, WithValidation
{

    protected $titleField = "fire_category_title";
    protected $modelClass = MetaFireCategory::class;
