...
class MetaUnsafeBehaviorTypeExcelImport implements ToCollection, WithHeadingRow, WithValidation
{

    protected $titleField = "unsafe_behavior_type_title";
    protected $modelClass = MetaUnsafeBehaviorType::class;
