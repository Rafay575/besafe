...
class MetaPtwItemExcelImport implements ToCollection, WithHeadingRow, WithValidation
{

    protected $titleField = "ptw_item_title";
    protected $modelClass = MetaPtwItem::class;
