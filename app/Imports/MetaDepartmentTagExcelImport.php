...
class MetaDepartmentTagExcelImport implements ToCollection, WithHeadingRow, WithValidation
{

    protected $titleField = "department_tag_title";
    protected $modelClass = MetaDepartmentTag::class;
