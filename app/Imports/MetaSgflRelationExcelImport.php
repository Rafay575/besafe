...
class MetaSgflRelationExcelImport implements ToCollection, WithHeadingRow, WithValidation
{

    protected $titleField = "sgfl_relation_title";
    protected $modelClass = MetaSgflRelation::class;
