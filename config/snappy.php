...
return [
    ...
    */
    ...
    'pdf' => [
        'enabled' => true,
        'binary' => env('PDF_BINARY', (env('APP_ENV') === 'production') ? base_path('vendor/h4cc/wkhtmltopdf-amd64/bin/wkhtmltopdf-amd64') : base_path('vendor/wemersonjanuario/wkhtmltopdf-windows/bin/64bit/wkhtmltopdf')),
        'timeout' => false,
        'options' => [],
        'env' => [],
    ],
