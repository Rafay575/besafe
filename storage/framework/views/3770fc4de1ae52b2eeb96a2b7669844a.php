...
<div class="row ">
  <div class="col-12 mx-auto ">
    <form action="<?php echo e(route('slapolicies.store')); ?>" method="POST">
      <?php echo csrf_field(); ?>
      <div class="row">
        <div class="col-12">
                        ...
                        <tbody>
                          <?php $__currentLoopData = $priorities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $priority): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <tr>
                                ...
                                <td><input type="text" name="<?php echo e(strtolower($priority->priority)); ?>_first_response_time" class="form-control" placeholder="10m"></td>
                                <td><input type="text" name="<?php echo e(strtolower($priority->priority)); ?>_resolution_time" class="form-control" placeholder="10m"></td>
                                <td>
                                ...
                                <td>
                                    <div class="form-check form-switch">
                                        ...
                                        <input name="<?php echo e(strtolower($priority->priority)); ?>_escalation" class="form-check-input" type="checkbox" checked>
                                    </div>
                                </td>
                            </tr>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\flexi\resources\views/slapolicy/create.blade.php ENDPATH**/ ?>