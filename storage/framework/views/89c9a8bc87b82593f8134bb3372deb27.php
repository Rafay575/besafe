                ...
                <td>
                   <div style="width: 45%;">
                    ...
                    <?php if($ticket->status == "Open"): ?>
                      <?php if($ticket->tickettype->name == "HRPSP POC"): ?>
                        <?php if($ticket->current_level > 1): ?>
                          <a 
                              href="<?php echo e(route('tickets.reassign', $ticket->id)); ?>" 
                              class="mx-2" 
                              data-bs-toggle="tooltip" 
                              data-bs-placement="top" 
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\flexi\resources\views/tickets/assign.blade.php ENDPATH**/ ?>