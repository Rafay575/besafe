...
unset($__errorArgs, $__bag); ?>">
                    ...
                    <input type="text" name="name" class="form-control" id="name" value="<?php echo e($user->name); ?>" placeholder="Name">
...
unset($__errorArgs, $__bag); ?>">
                  ...
                  <select class="form-control" name="department_id" id="department_id" >
                      <?php $__currentLoopData = $departments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $department): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option <?php echo e($user->department_id == $department->id ? "selected" : ""); ?> value="<?php echo e($department->id); ?>"><?php echo e($department->name); ?></option>
...
unset($__errorArgs, $__bag); ?>">
                  ...
                  <select class="form-control" name="designation_id" id="designation_id" >
                      <?php $__currentLoopData = $designations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $designation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option <?php echo e($user->designation_id == $designation->id ? "selected" : ""); ?> value="<?php echo e($designation->id); ?>"><?php echo e($designation->name); ?></option>
                      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                  </div>
...
unset($__errorArgs, $__bag); ?>">
                    ...
                    <input type="number" name="mobile" class="form-control" id="mobile" value="<?php echo e($user->mobile); ?>" placeholder="Mobile Number">
...
unset($__errorArgs, $__bag); ?>">
                    ...
                    <input type="text" name="grade" class="form-control" id="grade" value="<?php echo e($user->grade); ?>" placeholder="Grade">
...
unset($__errorArgs, $__bag); ?>
                  ...
                  <div class="form-group col-md-2 <?php $__errorArgs = ['user_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                    ...
                    <input type="text" name="user_id" value="<?php echo e($user->user_id); ?>" class="form-control" id="user_id" placeholder="User ID">
...
unset($__errorArgs, $__bag); ?>">
                  ...
                  <select class="form-control" name="roles" id="roles" >
                      <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option <?php echo e($user->roles->pluck('name')->first() == $role->name ? "selected" : ""); ?> value="<?php echo e($role->name); ?>"><?php echo e($role->name); ?></option>
                      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                  </div>
...
unset($__errorArgs, $__bag); ?>">
                  ...
                  <select class="form-control" name="region_id" id="region_id" >
                      <?php $__currentLoopData = $regions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $region): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option <?php echo e($user->region_id == $region->id ? "selected" : ""); ?> value="<?php echo e($region->id); ?>"><?php echo e($region->name); ?></option>
                      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                  </div>
...
unset($__errorArgs, $__bag); ?>">
                  ...
                  <select class="form-control" name="sub_region_id" id="sub_region_id" >
                      <?php $__currentLoopData = $sub_regions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sub_region): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option <?php echo e($user->sub_region_id == $sub_region->id ? "selected" : ""); ?> value="<?php echo e($sub_region->id); ?>"><?php echo e($sub_region->name); ?></option>
                      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                  </div>
                  ...
                  <div class="form-group col-md-2 mt-4">
                    <div class="form-check">
                      <input class="form-check-input" type="checkbox" value="1" id="poc_user" name="poc_user" <?php echo e($user->poc_user == 1 ? "checked" : ""); ?>>
...
unset($__errorArgs, $__bag); ?>">
                    ...
                    <input type="text" name="secondary_email" value="<?php echo e($user->secondary_email); ?>" class="form-control" id="secondary_email" placeholder="Secondary Email Address">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\flexi\resources\views/users/edit.blade.php ENDPATH**/ ?>