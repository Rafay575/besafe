...
<aside
    ...
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href="#">
            <img src="<?php echo e(asset('website/img/logo.png')); ?>" class="navbar-brand-img h-100" alt="main_logo">
    ...
    <div class="collapse navbar-collapse  w-auto h-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a data-bs-toggle="collapse" href="#dashboardsExamples" class="nav-link collapsed"
                        ...
                        <div class="icon icon-shape icon-sm text-center d-flex align-items-center justify-content-center">
                            <img src="<?php echo e(asset('website/nav_icons/User.ico')); ?>" alt="" width="18">
                        </div>
                        <span class="nav-link-text ms-1 ">Users Management</span>
                    </a>
                    <div class="collapse" id="dashboardsExamples"> 
                        <ul class="nav ms-4">
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check(['user.edit', 'user.index'])): ?>
                                <li class="nav-item ">
                            ...
                            <?php endif; ?>
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check(['employee.edit', 'employee.index'])): ?>
                                <li class="nav-item ">
                            ...
                            <?php endif; ?>
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check(['role.index', 'role.edit'])): ?>
                                <li class="nav-item ">
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check(['ticket.index', 'ticket.edit'])): ?>
                <li class="nav-item">
                    <a class="nav-link <?php echo e(request()->is('tickets') ? 'active' : ''); ?>" href="<?php echo e(route('tickets.index')); ?>">
                        <div
                            class="icon icon-shape icon-sm text-center  me-2 d-flex align-items-center justify-content-center">
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check(['adminsetting.index', 'adminsetting.edit'])): ?>
                <li class="nav-item">
                    <hr class="horizontal dark">
                <li class="nav-item">
                    <a class="nav-link <?php echo e(request()->is('adminpanel') ? 'active' : ''); ?>" data-bs-toggle="collapse" href="#employeeSettings" class="nav-link" aria-controls="employeeSettings"
                    ...
                    <div class="collapse" id="employeeSettings" style="">
                        <ul class="nav ms-4">
                            ...
                            <li class="nav-item">
                                <a class="nav-link <?php echo e(request()->is('businesshours') ? 'active' : ''); ?>"
                                    href="<?php echo e(route('businesshours.index')); ?>">
                                    <span class="nav-link-text ms-2">Business Hours</span>
                                </a>
                            </li>

                            <li class="nav-item">
                                <a class="nav-link <?php echo e(request()->is('slapolicies') ? 'active' : ''); ?>"
                                    href="<?php echo e(route('slapolicies.index')); ?>">
                                    <span class="nav-link-text ms-2">SLA Policies</span>
                                </a>
                            </li>

                            <li class="nav-item">
                                <a class="nav-link <?php echo e(request()->is('tickets') ? 'active' : ''); ?>"
                            ...
                            <li class="nav-item ">
                                ...
                                <div class="collapse " id="employeeSubSetting" style="">
                                    <ul class="nav nav-sm flex-column">
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('hazard.index')): ?>
                                            <li class="nav-item">
                                                <a class="nav-link <?php echo e(request()->is('designations') ? 'active' : ''); ?>"
                                        ...
                                        <?php endif; ?>
                                        <li class="nav-item">
                                            <a class="nav-link <?php echo e(request()->is('departments') ? 'active' : ''); ?>"
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link <?php echo e(request()->is('grades') ? 'active' : ''); ?>"
                                                href="<?php echo e(route('grades.index')); ?>">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link <?php echo e(request()->is('regions') ? 'active' : ''); ?>"
                                                href="<?php echo e(route('regions.index')); ?>">
                            ...
                            <li class="nav-item ">
                                ...
                                <div class="collapse" id="ticketSetting" style="">
                                    <ul class="nav nav-sm flex-column">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link <?php echo e(request()->is('tickettypes') ? 'active' : ''); ?>"
                                                href="<?php echo e(route('tickettypes.index')); ?>">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link <?php echo e(request()->is('ticketsubtypes') ? 'active' : ''); ?>"
                                                href="<?php echo e(route('ticketsubtypes.index')); ?>">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link <?php echo e(request()->is('ticketsetting') ? 'active' : ''); ?>"
                                                href="<?php echo e(route('ticketsetting.index')); ?>">
...
</aside><?php /**PATH C:\wamp64\www\flexi\resources\views/layouts/partials/site_nav.blade.php ENDPATH**/ ?>