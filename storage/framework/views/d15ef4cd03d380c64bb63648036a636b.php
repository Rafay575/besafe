...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
      ...
      <li class="breadcrumb-item text-sm text-white active"><a class="opacity-5 text-white" href="javascript:;">Create User</a></li>
    </ol>
    <h6 class="font-weight-bolder mb-0 text-white">Create New User</h6>
  </nav>
...
unset($__errorArgs, $__bag); ?>">
                  ...
                  <div class="form-group col-md-2 mt-4">
                    <div class="form-check">
                      <input class="form-check-input" type="checkbox" value="1" id="poc_user" name="poc_user">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\flexi\resources\views/users/create.blade.php ENDPATH**/ ?>