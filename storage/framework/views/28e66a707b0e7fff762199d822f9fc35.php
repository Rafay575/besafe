        ...
        <table class="table table-striped table-hover">
            ...
            <tbody>
                ...
                <?php $__currentLoopData = $tickets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ticket): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td style="padding:10px"><?php echo e($ticket['ticket']); ?></td>
                        <td style="padding:10px"><?php echo e($ticket['subject']); ?></td>
                        <td style="padding:10px"><?php echo e($ticket['raised_by']); ?></td>
                        <td style="padding:10px"><?php echo e($ticket['resolved_by']); ?></td>
                        <td style="padding:10px">
                            ...
                            <?php if($ticket['rating'] == 5): ?>
                                <span>😁</span> <!-- Emoji for 5 stars -->
                            <?php elseif($ticket['rating'] >= 4): ?>
                                <span>😊</span> <!-- Emoji for 4 stars -->
                            <?php elseif($ticket['rating'] >= 3): ?>
                                <span>🙂</span> <!-- Emoji for 3 stars -->
                            <?php elseif($ticket['rating'] >= 2): ?>
...
<?php /**PATH C:\wamp64\www\flexi\resources\views/dashboard/partials/bottom_table.blade.php ENDPATH**/ ?>